...
@section('title', 'NutriCoc | Obstetricia')
    ...
    <div class="card">
        <form action="" method="get">
            ...
            <div class="card-header">
                ...
                <div class="row">
                    <div class="col">
                        <h3>Solicitar Dieta para Paciente Obstetrico</h3>
                    </div>
                </div>
            </div>
        </form>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal"  action="{{ route('obstetriciaPaciente') }}" method="GET">
                            @csrf
                            <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('obstetriciaResetear') }}"  class="btn btn-warning float-right ml-2"><i class='fas fa-sync'></i> Resetear</a>
