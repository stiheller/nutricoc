...
@section('title', 'NutriCoc | Monitor Pedidos Dieta')
...
@section('content')
        <div class="card">
            <form action="{{ route('monitorPedidos') }}" method="get">
                @csrf
                <div class="card-header">
                    @include('layouts.session_message')
                    <div class="row">
                        <div class="col">
                            <h3>Listado de Dietas Pacientes</h3>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" role="menu">
                                    <a class="dropdown-item" href="{{ route('guardiaPedir') }}" target="_blank"><i class='fas fa-hospital'></i> Guardia</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('obstetriciaResetear') }}" target="_blank"><i class='fas fa-baby'></i> Obstetricia</a>
                                </div>
                            </div>
                    ...
                    <tbody>
                        @foreach($registros as $r)
                            ...
                            <tr style="{{ $color }}">
                                        ...
                                        <div class="dropdown-menu">
                                            @switch($r->estado_id)
                                                @case(1)
                                                    ...
                                                    <a class='dropdown-item' href='#' onclick='accionPedidoGuardia(this.id);' id='X|0|{{ $r->id }}' data-toggle="modal" data-target="#modal-lg-clave-guardia"><i class='fas fa-trash-alt fa-fw'></i> Heller|Eliminar Pedido</a><div class='dropdown-divider'></div>
                                                    <a class='dropdown-item' href='#' onclick='accionPedidoGuardia(this.id);' id='A|5|{{ $r->id }}' data-toggle='modal' data-target='#modal-lg-clave-guardia'><i class='fas fa-exchange-alt'></i> Heller|Anular Pedido por Pase</a><div class='dropdown-divider'></div>
                                                    <a class='dropdown-item' href='#' onclick='accionPedidoGuardia(this.id);' id='A|6|{{ $r->id }}' data-toggle='modal' data-target='#modal-lg-clave-guardia'><i class='fas fa-door-open'></i> Heller|Anular Pedido por Alta Paciente</a><div class='dropdown-divider'></div>
                                                    <a class='dropdown-item' href='#' onclick='accionPedidoGuardia(this.id);' id='A|7|{{ $r->id }}' data-toggle='modal' data-target='#modal-lg-clave-guardia'><i class='fas fa-notes-medical'></i> Heller|Anular Pedido por Tratamiento</a><div class='dropdown-divider'></div>
                                                    <a class='dropdown-item' href='{{ route('logdieta', $r->id) }}' target="_blank"><i class='fas fa-user-secret'></i> Log Dieta</a>
                                ...
                                <td class="text-center"><i class='{{ $r->icon }} fa-2x' title="{{ $r->origen }}"></i></td>
                                <td>{{ $r->apenom }}</td>
